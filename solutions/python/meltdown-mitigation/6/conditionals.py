...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    critical_condition = temperature < critical_temp_k and neutrons_emitted > critical_neutrons_1ps and product_temp_neutrons < critical_product_temp_neutrons    
    
    if bool(critical_condition):
