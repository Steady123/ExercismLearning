...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    NORMAL_threshold_lower = threshold * 0.9
    NORMAL_threshold_upper = threshold * 1.1
    
    if reactor_threshold < LOW_threshold:
        status_code = 'LOW'
    elif reactor_threshold > NORMAL_threshold_lower and reactor_threshold < NORMAL_threshold_upper:
        status_code = 'NORMAL'
    else:
        status_code = 'DANGER'
